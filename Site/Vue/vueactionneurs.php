...
<div class="content">
    <div class="main_bloc">
        <form method="post" action="../Modele/modeleactionneurs.php">
            <p align="middle">
            <table>
                <tr>
                    <th align="middle">Id de l'actionneur</th>
                    <th align="middle">Type de l'actionneur</th>
            ...
            <br />
            <label for="fonction">Actionneur :<br /></label>
            <select name="fonction" class="barre">
                <option disabled selected> Type d'actionneur</option>
                <?php
